...
<script type="text/javascript">
	...
	$(function() {
		...
		$('table#paymentList span.spanEdit').click(
				function() {
					$.getJSON( //加载数据-----start----------
					"admin/paymentNoFixedList!getPaymentInfo", {
								...
								{ //弹出编辑框-----start----------				
									...
									buttons : {
										"更新" : function() {
											...
											$("#paymentForm").attr("action","admin/paymentNoFixedList!paymentEdit"); //设置form的action属性
		...
		$('#delSelect').click(
				function() {
					...
					if (confirm("确定删除所选？")) {
						$('#formData').attr("action","admin/paymentNoFixedList!delPaymentLists");
						$('#formData').submit();
					} else {
					}
				});
...
<body>
	...
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="admin/paymentNoFixedList">居民非固定费用缴费查询</a></li>
			<li>基本内容</li>
		</ul>
	</div>
	<!-- 导航栏结束 -->
	...
	<!-- form表单开始 -->
	<form id="formData" action="admin/paymentNoFixedList" method="post"
		onsubmit="return check();">
		<div class="rightinfo">
			<!-- 工具栏开始 -->
			<div class="tools">
				<ul class="toolbar">
					<li id="addInfo"><span><img src="images/t01.png" /></span><a href="admin/paymentNoFixedList!costInit_NoFixed">添加收费信息</a></li>
			...
			<table id="paymentList" class="tablelist" style="text-align: center;">
				...
				<tbody>
					<s:iterator var="item" value="paymentNoFixedList" status="stat">
						<tr class="trZebra">
		...
		<s:set var="actionName" value="'admin/paymentNoFixedList'"></s:set>
