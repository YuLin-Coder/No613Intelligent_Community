 ...
 * 
 */
@Component(value = "payment_NoFixedDao")
public class PaymentNoFixedDao {
	...
	public int getDataNum() {
		return this.hibernateTemplate.find(
				"from PaymentBean p where p.costModel.costTypeModel.ctId=02")
				.size();
	}
	...
	public List<PaymentBean> getPaymentList_NoFixed(final PagerView pager) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<CostBean> getCostList_NoFixed() {
		return this.hibernateTemplate
				.find("from CostBean c where c.costTypeModel.ctId=02");
	}
